...
DEAEDDEDBCEEECECDEEDDBEEECEEDEE
...
Please Enter the string
EEBEACCCCAADACCBCCCCECCCEEECCCE
the letter count is 5
the tree's WPL  is  56
A Huffman code:  001
B Huffman code:  0001
...
2. 该代码可以对大写字母的字符串进行huffman编码，如果要读小写字母字符串进行编码，应该如何修改？如果想要对同时具有大写和小写字母的字符串都进行编码呢（写出思路即可）？
   ...
   将代码中的0x41改为0x61即可统计小写字母

   将j改为2*j即可对大小写字母都可以编码

3. 使用画图工具画出上述两个Huffman生成树的生成过程

![哈2](C:\Users\黄\Desktop\哈2.png)![哈1](C:\Users\黄\Desktop\哈1.png)